...
<div class="form-group">
    <label for="name" class="control-label col-sm-offset-3 col-sm-2">{!! Lang::get('langCommon.CHARGE') !!}</label>
    <div class="col-sm-2">
  ...
  <div class="form-group">
    <label for="number" class="control-label col-sm-offset-3 col-sm-2">{!! Lang::get('langCommon.COURSE') !!}</label>
    <div class="col-sm-2">
      <select class="form-control" id="number" name="number">
